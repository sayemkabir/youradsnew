    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li><a class="nav-link scrollto" href="#categories">Exciting Categories</a></li>
                <li><a class="nav-link scrollto" href="#services">Why choose us?</a></li>
...
{{--                <li><a class="nav-link scrollto" href="#contact">Contact</a></li>--}}
                @auth('user')
                    ...
                    <li><a class="register" href="{{route('user.logout')}}">Logout</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 d-flex flex-column justify-content-center">
                ...
                <div data-aos="fade-up" data-aos-delay="600">
                    <div class="text-center text-lg-start">
                        <a href="{{route('registration.form')}}" class="btn-get-started scrollto d-inline-flex align-items-center justify-content-center align-self-center">
            ...
            <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
                <img src="{{asset('frontend')}}/assets/img/connected.gif" class="img-fluid" alt="">
                <img src="{{asset('frontend')}}/assets/img/HTAC2.jpg" class="img-fluid" alt="">
            </div>
        </div>
    </div>
...
<main id="main">
    ...
    <section id="clients" class="clients">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <header class="section-header">
                <h2>Our Clients</h2>
                <p>Projects advertised within our platform</p><br>
            </header>
    ...
    <!-- ======= Values Section ======= -->
    <section id="categories" class="values">

        <div class="container" data-aos="fade-up">

            <header class="section-header">
                <h2>Our Ad Categories</h2>
                <p>We Offer Various Categories To Choose From</p>
            </header>
         ...
         @foreach($categories as $data)
                ...
                <div class="col-lg-4">
                    ...
                    <div class="box" data-aos="fade-up" data-aos-delay="200">
                        <img src="{{url('/images/categories/',$data->image)}}" class="img-fluid" alt="">
                        <h3>{{$data->name}}</h3>
...
{{--    </section><!-- End Features Section -->--}}
    ...
    <section id="services" class="services">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <header class="section-header">
                <h2>Why Choose Us?</h2>
                <p>Because we offer best services to our users</p>
            </header>
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="service-box orange">
                        <img src="{{asset('frontend')}}/assets/img/protected.png" class="img-fluid" alt="">
                        <br><br>
                        <br><br>
                        <h3>High quality traffic</h3>
                        <p>With our innovation quality control system, we are proud that the traffic we delivered is 99.99% real.
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                    <div class="service-box blue">
                        <img src="{{asset('frontend')}}/assets/img/coins.png" class="img-fluid" alt="">
                        <br><br>
                        <br><br>
                        <h3>Affordable price</h3>
                        <p>1000 unique visitors to your website start from only $1.2. With a few dollars you can start your advertising
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
                    <div class="service-box green">
                        <img src="{{asset('frontend')}}/assets/img/setting.png" class="img-fluid" alt="">
                        <br><br>
                        <br><br>                        <h3>Easy management</h3>
                        <p>Just provide your website url, description. You can start a campaign in few minutes. Detailed traffic report will be provided for tracking.</p>
                    </div>
                </div>
...
@auth('user')
    @php
        $checkTicket=App\Models\Ticket::where('user_id',auth('user')->user()->id)->where('date',now()->format('Y-m-d'))->get();
    ...
    @if($checkTicket->count() == 0)
            ...
            <section id="contact" class="contact">
                ...
                <div class="container" data-aos="fade-up">
                    ...
                    <header class="section-header">
                        <h2>Support</h2>
                        <p>Create a ticket regarding your issue</p>
                    </header>
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-lg-12">
                            <form action="{{route('user.ticket')}}" method="post" class="php-email-form">
                                @csrf
                                <div class="row gy-4">

                                    <div class="col-md-6">
                                        <label for="">Your username:</label>
                                        <input type="text" readonly value="{{auth('user')->user()->user_name}}"  class="form-control" placeholder="Your Name" required>
                                    </div>
                                    <input type="text" hidden name="userId" value="{{auth('user')->user()->id}}">
                                    <input type="date" hidden name="date" value="{{now()->format('Y-m-d')}}">
                                    <div class="col-md-6 ">
                                        <label for="">Your email:</label>
                                        <input type="email" readonly value="{{auth('user')->user()->email}}" class="form-control"  placeholder="Your Email" required>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <label for="">Tell us your problem in brief:</label>
                                        <textarea class="form-control" name="message" rows="6" placeholder="Message" required></textarea>
                                    </div>

                                    <div class="col-md-12 text-center">
                                        <div class="loading">Loading</div>
                                        <div class="sent-message">Your Ticket was created successfully. Thank you!</div>
                                        ...
                                        <button class="btn btn-warning" type="submit">Create Ticket</button>
    ...
    @else
            <section id="contact" class="contact">
                ...
                <div class="container" data-aos="fade-up">
                    ...
                    <center>
                        <h3 style="color: royalblue">You Created Ticket Is Under Review.</h3> <br>
                        <h4 style="color: deepskyblue">If the issue is not solved, you can create a new ticket Again Tomorrow. Thank You !!!</h4>
                    </center>
...
{{--    </div>--}}
    ...
    <div class="container">
        ...
        <div class="credits">
            ...
            Designed by <a href="https://www.facebook.com/me.sayem.islam/">Admin</a>
        </div>
    </div>
</footer><!-- End Footer -->
